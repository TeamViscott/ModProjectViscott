...
public class PressureTurret extends ReloadTurret {
    ...
    public float pressureRequirement = -1f;
    /** Maximum efficiency possible, if this turret uses heat. */
    public float maxPressureEfficiency = 3f;
    ...
    public void setStats(){
        ...
        if(pressureRequirement > 0) stats.add(Stat.input, pressureRequirement, PvStatUnits.pressureUnits);
    }
    ...
    public class PressureTurretBuild extends ReloadTurretBuild implements ControlBlock{
        ...
        public void updateTile(){
            ...
            if(pressureRequirement > 0){
                pressureReq = calculateHeat(sidePressure);
            }
        ...
        public void updateEfficiencyMultiplier(){
            if(pressureRequirement > 0){
                efficiency *= Math.min(pressureReq / pressureRequirement, maxPressureEfficiency);
            }
        }
